...
`;
  ...
  function setupStudioGallery() {
    ...
    fetch('/api/gallery?admin=0', { cache: 'no-store' }).then((r) => r.ok ? r.json() : Promise.reject(new Error('gallery'))).then((data) => {
      ...
      const patterns={1:[[12]],2:[[8,4]],3:[[7,5]],4:[[7,5],[5,7]],5:[[7,5],[4,4,4]],6:[[7,5],[4,4,4]],7:[[7,5],[4,3],[6,4]],8:[[7,5],[3,3,3,3],[6,6]],9:[[7,5],[3,3,3,3],[4,4,4]],10:[[7,5],[3,3,3,3],[3,3,3,3]],11:[[7,5],[3,3,3,3],[3,3,2,2,2]],12:[[7,5],[3,3,3,3],[2,2,2,2,2,2]]};
