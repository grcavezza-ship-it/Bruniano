...
const SITE_URL = 'https://www.centromedicobruniano.it';
const STATIC_PATHS = [
  '/',
  '/trattamenti.html',
  '/studio.html',
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Blog URLs are an enhancement; the sitemap must still work when the DB is temporarily unavailable.
    try {
      const sql = db();
      ...
      console.error('Sitemap blog enrichment error:', blogError);
    }
