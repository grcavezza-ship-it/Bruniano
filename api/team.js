...
export default async function handler(req, res) {
  try {
    ...
    if (req.method === 'POST' || req.method === 'PUT') {
      ...
      if (name.length > 200 || role.length > 200 || specialty.length > 300 || bio.length > 5000 || photoUrl.length > 2048) {
      ...
      const curricula = await getCurricula(sql);
      curricula[saved.id] = body.curriculum && typeof body.curriculum === 'object' ? body.curriculum : {};
